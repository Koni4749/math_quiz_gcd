...
<style>
    ...
    .sub-card { padding:20px; background:#f7f7f9; border-radius:10px; border:1px solid #ddd; }
    .result-card { padding:25px; background:#eef9ff; border-radius:10px; border:2px solid #40a6ff; }
</style>
...
if step==1:
    ...
    show_problem("[문제 1]", f"숫자 {num1}을(를) 소인수분해 하세요.", num1, "q1", is_text=True)
